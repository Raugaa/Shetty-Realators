      ...
      <section className="bg-yellow-primary pt-24 pb-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className={`max-w-7xl mx-auto text-center relative z-10 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0'}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center animate-fade-in animate-delay-400">
            <Button size="lg" className="bg-dark-gray text-white hover:bg-dark-gray/90 px-8 py-4 text-lg font-semibold rounded-xl transition-all duration-300 hover:scale-105">
