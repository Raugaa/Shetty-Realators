...
const CallToAction = () => {
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800 dark:bg-slate-900">
      <div className="max-w-7xl mx-auto">
        <Card className="professional-card bg-slate-700 dark:bg-slate-800 border-none text-white overflow-hidden relative">
          <CardContent className="relative z-10 p-12 text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 animate-fade-in text-white">
              Ready to Find Your Dream Property?
            </h2>
            <p className="text-xl mb-10 max-w-3xl mx-auto text-gray-200 animate-fade-in animate-delay-200">
